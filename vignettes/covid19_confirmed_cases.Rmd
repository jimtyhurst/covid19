...
Plots cumulative number of confirmed cases for a few select states in the western part of the United States.

```{r total_by_state_summary, echo = FALSE, message = FALSE}
confirmed_cases %>%
  dplyr::filter(province_state %in% c("Arizona", "California", "Colorado", "Oregon", "Washington")) %>% 
  ...
  ggtitle("Confirmed cases in a few western states") +
  labs(x = "Date", y = "Cumulative Total", color = "State")
```

Plots cumulative number of confirmed cases in China, Italy, Iran, Spain, South Korea, and United States. New cases have already leveled off in China and South Korea, but new cases are still increasing in the other countries.
